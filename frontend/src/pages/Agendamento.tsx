...
const Agendamento: React.FC = () => {
  ...
  const HistoricoConsultas: React.FC<{ consultas: Consulta[] }> = ({
    consultas,
  }) => {
    return (
          ...
          <div className="historico-grid">
            {consultas.map((consulta, index) => (
              <div key={index} className="consulta-card">
                ...
                <p>
                  <strong>Data:</strong> {formatDate(consulta.data)}
                </p>
                <p>
  ...
  return (
    <div className="agendamento-container">
      <h2>
        Agendamento de <span>Consulta</span>
      </h2>

      {showSuccess && (
        <div className="mensagem-sucesso">Consulta agendada com sucesso!</div>
      )}
      ...
      <div className="agendamento-content">
          ...
          <div className="sessoes-container">
            ...
            <div className="sessoes-grid">
              {dentistasHorarios.map((dentista) => {
                ...
                const horariosDisponiveis = getHorariosByDate(
                  dentista,
                  selectedDate
                );
                  ...
                  <div key={dentista.nome} className="dentista-sessoes">
                    ...
                    <div className="horarios-grid">
                      {horariosDisponiveis.map((horario) => {
                        const disponivel = isHorarioDisponivel(
                          dentista.nome,
                          horario
                        );
                        const isSelected =
                          isSelectedDentista && selectedHorario === horario;
        ...
        <div
          className={`dados-paciente-container ${
            !selectedDentista || !selectedHorario ? "hidden" : ""
          }`}
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="consulta-info">
              ...
              <p>
                <strong>Profissional:</strong> {selectedDentista || ""}
              </p>
            </div>
