  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const userData = {
        ...
        tipo: isProfessional ? 'profissional' as const : 'paciente' as const,
        ...(isProfessional && { cro: response.cro || formData.cro })
      };
      ...
      if (error instanceof Error) {
        if (error.message.includes('Email ou Senha incorreto')) {
          errorMessage = 'Email ou senha incorretos.';
        } else if (error.message.includes('Email, CRO e Senha incorretos')) {
          errorMessage = 'Email, CRO ou senha incorretos.';
        } else if (error.message.includes('Faltando')) {
